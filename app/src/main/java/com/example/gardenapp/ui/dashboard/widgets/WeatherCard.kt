...
private fun WeatherSuccessContent(data: WeatherResponse) {
    Row(
        ...
        // TODO: Use a real image loader like Coil for the icon from data.current.condition.iconUrl
...
private fun ForecastItem(forecastDay: com.example.gardenapp.data.weather.ForecastDay) {
    ...
    Column(horizontalAlignment = Alignment.CenterHorizontally) {
        ...
        // TODO: Use a real image loader like Coil for the icon
        Icon(Icons.Outlined.Thermostat, contentDescription = null, modifier = Modifier.size(24.dp), tint = MaterialTheme.colorScheme.onSurfaceVariant)
