...
interface ReferenceDao {
    ...
    fun getVariety(id: String): Flow<ReferenceVarietyEntity?> // ADDED THIS

    @Query("SELECT * FROM ref_cultures WHERE groupId = :groupId ORDER BY title") fun getCulturesByGroup(groupId: String): Flow<List<ReferenceCultureEntity>>
    @Query("SELECT * FROM ref_varieties WHERE cultureId = :cultureId ORDER BY title") fun getVarietiesByCulture(cultureId: String): Flow<List<ReferenceVarietyEntity>>
    @Query("SELECT * FROM ref_variety_tags WHERE varietyId = :varietyId") fun getTagsForVariety(varietyId: String): Flow<List<ReferenceTagEntity>>
}
